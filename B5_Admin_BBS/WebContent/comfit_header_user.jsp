        ...
        <div class="container">
            <a href="/" > 
	           <img alt="logo" src="<%=cp%>/images/logo.png" style="width: 200px;">
              	...
              	<div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent" style="border: 1px solid gray">
              		<br />
                 	<form class="form-inline" style="width: 100%;">
				     	<div class="input-group" style="width:70%; padding-left: 20%">
