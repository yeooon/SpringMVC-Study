				...
				<table class="table table-striped">
					...
					<tr>
						<td>
							<div class="input-group" role="group">
								...
								placeholder="sid" required="required"/>
								<span class="input-group-addon">30자</span>
							</div>
						</td>
					</tr>
					...
					<tr>
						<td>
							<div class="input-group" role="group">
								...
								placeholder="tel"/>
								<span class="input-group-addon">40자</span>								
							</div>
						</td>
					</tr>
					...
					<tr>
						<td colspan="2" style="text-align: center;">
							...
							<span style="font-size: small;">(※)는 필수 입력 사항</span>
							<span id="errMsg"
							style="font-size: small; color: red; display: none;">
							필수입력 사항을 모두 입력해야 합니다.</span>
						</td>
					</tr>
