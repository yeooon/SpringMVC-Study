...
SELECT *
FROM EMPLOYEE;
--==>>1	김상기	???X?-w??	1996-10-04	0	010-5693-4233	1	2	1	2500000	1500000
...
--==>>
/*
1	김상기	???X?-w??	1996-10-04	0	양력	010-5693-4233	1	개발부	2	대리	1	서울	2500000	1500000	4000000
*/
...
-- 이와 관련하여  EMPLOYEEID(사원아이디) 와 SSN(주민번호) 뒷자리 7자리 숫자를 
-- 이용할 수 있도록 구성한다.
...
SELECT *
FROM EMPLOYEE;
--==>> 1	김상기	???X?-w??	1996-10-04	0	010-5693-4233	1	2	1	2500000	1500000	961004	=o???
...
SELECT *
FROM EMPLOYEE;
--==>> 1	김상기	1996-10-04	0	010-5693-4233	1	2	1	2500000	1500000	961004	=o???	1
...
SELECT *
FROM EMPLOYEE;
--==>> 1	김상기	1996-10-04	0	010-5693-4233	1	2	1	2500000	1500000	961004	=o???	0
...
--==>>
/*
1	김상기	961004	1996-10-04	0	양력	010-5693-4233	1	개발부	2	대리	1	서울	2500000	1500000	4000000
2	이연주	950816	1995-08-16	0	양력	010-4423-0463	1	개발부	1	사원	1	서울	1500000	1500000	3000000
*/
...
WHERE EMPLOYEEID=1;
--> 한 줄 구성
UPDATE EMPLOYEE SET NAME='김상기', BIRTHDAY=TO_DATE('1996-10-04','YYYY-MM-DD'), LUNAR=0, TELEPHONE='010-5693-4223', DEPARTMENTID=1, POSITIONID=2, REGIONID=1, BASICPAY=2500000, EXTRAPAY=1500000, SSN1='961004', SSN2=CRYPTPACK.ENCRYPT('1234567','12346557'), GRADE=0 WHERE EMPLOYEEID=1
;
--==>> 1 행 이(가) 업데이트되었습니다.
