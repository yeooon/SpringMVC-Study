...
<%
	...
	//String contentType = request.getRealPath("/");	//-- 예전 방식
	...
	try
	{
		...
		out.println("작성자 : " +  multi.getParameter("userName") + "<hr>");
		out.println("제목 : " + multi.getParameter("subject") + "<br>");
		out.println("서버에 저장된 파일명 : " + multi.getOriginalFileName("uploadFile") + "<br>");
